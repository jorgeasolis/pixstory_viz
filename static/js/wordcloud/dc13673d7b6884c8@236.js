...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["dream.txt", {url: new URL("../../../data/narratives5.json", import.meta.url), mimeType: "application/json", toString}]
    //["dream.txt", {url: new URL("../../../data/narratives_pix_2.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
  ...
  main.variable().define("viewof source", ["Inputs","FileAttachment","width"], _source);
  main.variable().define("source", ["Generators", "viewof source"], (G, _) => G.input(_));
  main.variable().define(["md"], _5);
  main.variable(observer("WordCloud")).define("WordCloud", ["d3","d3Cloud"], _WordCloud);
  main.variable().define(["md"], _7);
  main.variable().define("words", ["source","stopwords"], _words);
  main.variable().define(["words"], _9);
  main.variable().define("stopwords", _stopwords);
  main.variable().define(["WordCloud"], _11);
