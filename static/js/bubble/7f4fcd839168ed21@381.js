...
md`# Bubble Chart (Interest Tags over 50)
...
FileAttachment("InterestTags_BubbleGraph_over50.csv").csv({typed: true})
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["InterestTags_BubbleGraph_over50.csv", {url: new URL("../../../data/4bd7bb68b2d228836c685d013afdcd8ff75a38daa61b3a618c491eb5b55e6bac7feefa0ebcee2c404ae27b8a062510b62098fc7bf8f80c8f0daff0b5a1834c17.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  //main.variable(observer()).define(["md"], _1);
  main.variable().define("key", ["Swatches","chart"], _key);
  main.variable(observer("chart")).define("chart", ["BubbleChart","files"], _chart);
  main.variable().define("flare", ["FileAttachment"], _flare);
  main.variable().define("files", ["flare"], _files);
