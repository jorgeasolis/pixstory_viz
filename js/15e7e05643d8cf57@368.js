...
function Pack(data, { // data is either tabular (array of objects) or hierarchy (nested objects)
  ...
  const container = d3.select("#statesvg");
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["data.json", {url: new URL("../data/86d7b8563e157d0c0ff5ee262550adef90c76f0d7e9e68dfae773a35af48148bc2a0e87c8bf3fa090ec7e8079b63f92516b5b6508a478f4169f7a88ffa5e8823.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
  ...
  main.variable().define("Pack", ["d3","location"], _Pack);
  main.variable().define("CirclePacking", ["Pack"], _CirclePacking);
